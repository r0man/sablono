(ns sablono.spec
  (:require [clojure.spec :as s]
            ...
            ;; [clojure.test.check.generators :as gen2 :refer [recursive-gen]]
            ))
...
;; (defn gen-element-with-attributes
;;   [child-gen]
;;   (s/gen (s/tuple ::html-type ::html-attributes child-gen)))

;; (defn gen-element-without-attributes
;;   [child-gen]
;;   (s/gen (s/tuple ::html-type child-gen)))
...
;; (defn gen-elements
;;   [child-gen]
;;   (gen/one-of [(gen-element-with-attributes child-gen)
;;                (gen-element-without-attributes child-gen)]))

;; (gen/sample (gen-element-with-attributes int?))
;; (gen/sample (gen-element-without-attributes int?))
;; (gen/sample (gen-elements int?))

;; (def nested-elements
;;   (recursive-gen gen-elements (s/gen int?)))

;; (def nested-elements
;;   (recursive-gen gen-elements gen2/int))

;; ;; (gen/sample nested-elements)
...
;;   (def scalars (gen/one-of [(s/gen int?) (s/gen boolean?)]))

;;   (def my-json-like-thing (recursive-gen compound scalars))
